      ...
      >
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            <EmailShareButton subject="Read this Article on Farm.to" body={window.location.href}>
              <IconButton>
                <MailOutlineIcon />
              </IconButton>
            </EmailShareButton>
...
const SingleArticle = ({match}) => {
   const classes = useStyles();
    const {singleArticle,getArticle,articleLoading,likeArticle,articleMessage}=useContext(ArticleContext)
        ...
        {singleArticle ? (
          ...
          <Meta title={ singleArticle.title }/>
            ...
            <>
              ...
              <Link to={`/user/${userInfo[0]._id}`} style={{textDecoration: 'none'}}>
              ...
              <div style={{ textAlign: "right" }}>
                {singleArticle &&
                singleArticle.heartedAuthors.indexOf(userInfo[0]._id) > -1 ? (
                  <IconButton
                    onClick={() => likeArticle(match.params.articleid)}
                  >
