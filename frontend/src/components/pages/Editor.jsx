...
const Editor = (props) => {
  ...
  const {postArticle,articleLoading,articleMessage,singleArticle}=useContext(ArticleContext)
  ...
  return (
    <div className="articleEditor">
      ...
      <div>
        ...
        <form className="create-note m-auto px-5">
          <textarea
            cols="1"
            className="editor-title editor__textarea"
            id="editor-title"
          ...
          <div id="editableclass" className="editableclass"></div>
        </form>
        <form className="create-note m-auto"></form>
      </div>
      <div> </div>
    </div>
  );
